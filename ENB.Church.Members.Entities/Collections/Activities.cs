...
{
    public class Activities : CollectionBase<Activity>
    {
        /// <summary>
        ...
        public Activities(IList<Activity> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public Activities(CollectionBase<Activity> initialList) : base(initialList) { }
